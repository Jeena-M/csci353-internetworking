 ...
 */
static
void talk_to_user_and_server(int client_socket_fd, string uri, string host, int port, string outputfile)
{
...
int main(int argc, char *argv[])
{
    if (argc == 6){
        ...
        talk_to_user_and_server(client_socket_fd, uri, host, stoi(argv[3]), outputfile);
