...
void udt_send(string src_nodeid, string destination, string message, string target){
        ...
        if (command == "neighbors"){
            ...
            */
            ...
            if (targetWithoutColon == port){
                cout << "Cannot use udtsend command to send message to yourself.\n";
                continue;
            }
            ...
            if (neighbor_node_ids.size() == 0){
                ...
                if (isIn == false){
                    ...
                    udt_send(port, destination, message, targetWithoutColon);
                }
