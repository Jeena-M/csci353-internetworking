...
Replace "(Comments?)" with the command the grader should use to compile your code (should simply be "make pa1").
...
If you ask the grader to use something else, the grader will not be allowed to comply and you will get a zero for your assignment.
    To compile your code, the grader should type: make pa1
...
(A) Type-I Maze, Batch Mode : 50 out of 50 pts
(B) Type-II Maze, Batch Mode : 50 out of 50 pts
